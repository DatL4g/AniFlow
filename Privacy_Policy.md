...
This privacy policy is applicable to the AniFlow app (hereinafter referred to as "Application") for mobile devices, which was developed by Jeff Retz (DatLag) (hereinafter referred to as "Service Provider") as a an Open Source service. This service is provided "AS IS".
