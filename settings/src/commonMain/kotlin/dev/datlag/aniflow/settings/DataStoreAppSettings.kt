...
class DataStoreAppSettings(
    ...
    override val color: Flow<AppSettings.Color?> = dateStore.data.map { it.color }.distinctUntilChanged()
    override val titleLanguage: Flow<AppSettings.TitleLanguage?> = dateStore.data.map { it.titleLanguage }.distinctUntilChanged()
